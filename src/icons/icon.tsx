...
const icons = {
  ...
  user: (
    ...
    >
      <path
        d='M11.0832 12.25C11.0832 9.99484 9.255 8.16667 6.99984 8.16667C4.74467 8.16667 2.9165 9.99484 2.9165 12.25M6.99984 6.41667C5.71117 6.41667 4.6665 5.372 4.6665 4.08333C4.6665 2.79467 5.71117 1.75 6.99984 1.75C8.2885 1.75 9.33317 2.79467 9.33317 4.08333C9.33317 5.372 8.2885 6.41667 6.99984 6.41667Z'
        stroke='currentColor'
        strokeWidth='1.16667'
        strokeLinecap='round'
        strokeLinejoin='round'
  ...
  clock: (
    ...
    >
      <path
        opacity='0.4'
        d='M21.8569 11.8212C21.8569 17.3452 17.3799 21.8212 11.8569 21.8212C6.33393 21.8212 1.85693 17.3452 1.85693 11.8212C1.85693 6.29917 6.33393 1.82117 11.8569 1.82117C17.3799 1.82117 21.8569 6.29917 21.8569 11.8212Z'
        fill='currentColor'
      />
      <path
        d='M15.4309 15.6356C15.2999 15.6356 15.1679 15.6016 15.0469 15.5306L11.1209 13.1886C10.8949 13.0526 10.7559 12.8076 10.7559 12.5436V7.49664C10.7559 7.08264 11.0919 6.74664 11.5059 6.74664C11.9199 6.74664 12.2559 7.08264 12.2559 7.49664V12.1176L15.8159 14.2406C16.1709 14.4536 16.2879 14.9136 16.0759 15.2696C15.9349 15.5046 15.6859 15.6356 15.4309 15.6356Z'
        fill='currentColor'
      />
    </svg>
  ),
  ...
  edit: (
    ...
    >
      <path
        d='M12.25 5.39581V5.36665C12.25 4.71325 12.25 4.38656 12.1228 4.13699C12.011 3.91747 11.8325 3.73899 11.613 3.62714C11.3634 3.49998 11.0367 3.49998 10.3833 3.49998L1.75 3.49998M1.75 3.49998L1.75 9.79998C1.75 10.4534 1.75 10.7801 1.87716 11.0296C1.98901 11.2492 2.16749 11.4276 2.38701 11.5395C2.63657 11.6666 2.96327 11.6666 3.61667 11.6666H4.08333M1.75 3.49998L1.75 3.26665C1.75 2.93995 1.75 2.7766 1.81358 2.65182C1.86951 2.54206 1.95875 2.45282 2.06851 2.39689C2.19329 2.33331 2.35664 2.33331 2.68333 2.33331H5.44674C5.58941 2.33331 5.66075 2.33331 5.72789 2.34943C5.78741 2.36372 5.84431 2.38729 5.8965 2.41927C5.95537 2.45535 6.00581 2.50579 6.1067 2.60668L7 3.49998M9.33334 8.16665L10.5 9.33331M6.41667 12.25V10.7916L10.7917 6.41665L12.25 7.87498L7.875 12.25H6.41667Z'
        stroke='currentColor'
        strokeWidth='1.16667'
        strokeLinecap='round'
        strokeLinejoin='round'
  ...
  sparkle: (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className={`lucide lucide-sparkles w-${size} h-${size}`}
      aria-hidden='true'
    >
  ...
  zen: (
    ...
    >
      <path
        d='M2.8291 13.0804C9.90017 17.323 15.557 11.6661 14.8499 1.05956C4.24352 0.352443 -1.41308 6.00946 2.8291 13.0804ZM2.8291 13.0804C2.82902 13.0802 2.82918 13.0805 2.8291 13.0804ZM2.8291 13.0804L1 14.9088M2.8291 13.0804L6.65685 9.25194'
        stroke='currentColor'
        strokeWidth='2'
        strokeLinecap='round'
        strokeLinejoin='round'
...
const IconSet = ({ iconName, size, children }: IconSetProps) => {
  return (
    <div className='flex items-center gap-1'>
      <div style={{ width: size, height: size }}>{icons[iconName]}</div>
      {children}
    </div>
  );
};
